...
func TestConfigs(t *testing.T) {
	...
	testConfigsScenario := func(config string) {
		...
		env.queryWithNoError(t, r, "DROP TABLE IF EXISTS default.test_configs")
		env.queryWithNoError(t, r, "CREATE TABLE default.test_configs (v UInt64) ENGINE=MergeTree() ORDER BY tuple()")
